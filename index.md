...
[Download on the App Store →](#) *(link once live)*

---

## Features

- **SSH and Mosh out of the box**, with automatic fallback per host
- **On-device voice input** — Whisper runs entirely on your device, audio never leaves your phone
- **Customizable accessory bar** — modifier keys, arrows, any escape sequence. Build it in-app or author it in YAML and import from Files.app (iCloud Drive, Dropbox, anywhere)
...
For questions, feature requests, or bug reports, see the [support page](/support/).

---

<small>Shellton is built and operated by [Datons](https://datons.com). © Datons.</small>
